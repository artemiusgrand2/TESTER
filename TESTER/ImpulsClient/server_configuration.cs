...
namespace sdm.diagnostic_section_model
{
	[Serializable]
	...
	public class ServerConfiguration
	{
		...
		public static ServerConfiguration FromFile(string configFile)
		{
			...
			//çàãðóæàþ êîíôèãóðàöèþ ïðîãðàììû
			...
			{
                System.Windows.MessageBox.Show(string.Format("Ошибка {0} в файле {1}", error.Message, configFile));
                if(reader!=null)
                    reader.Close();
			}
